...
function useChart(props) {
  ...
  const externalTooltipLabelCallback = (ctx) => {
  ...
  const toggleDataset = useCallback((toggle) => {
  ...
  const toggleLegend = useCallback((legend) => {
  ...
  const globalOptions = useCallback(() => {
  ...
  }, [colors.primary, colors.transparent, externalTooltipHandler, fonts.base])
  ...
  return {
    getOrCreateTooltip: getOrCreateTooltip,
    externalTooltipHandler: externalTooltipHandler,
    externalTooltipLabelCallback: externalTooltipLabelCallback,
